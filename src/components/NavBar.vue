      ...
      <i-menu mode="horizontal" :active-name="activeName">
        ...
        <div class="layout-nav">
          <i-menu-item name="home" to="/home">
            <i-icon type="ios-home" size="24"></i-icon>自我简介
          </i-menu-item>
          <i-menu-item name="ability" to="/ability">
            <i-icon type="ios-stats" size="24"></i-icon>专业技能
          </i-menu-item>
          <i-menu-item name="experience" to="/experience">
            <i-icon type="ios-briefcase" size="24"></i-icon>工作经历
          </i-menu-item>
          <i-menu-item name="project" to="/project">
            <i-icon type="logo-codepen" size="24"></i-icon>项目集
          </i-menu-item>
          <i-menu-item name="evaluation" to="/evaluation">
            <i-icon type="ios-text" size="24"></i-icon>自我评价
          </i-menu-item>
          <i-menu-item name="education" to="/education">
            <i-icon type="ios-school" size="24"></i-icon>动效课堂
          </i-menu-item>
        </div>
      </i-menu>
    </i-header>
