<template>
  <div class="layout">
    <i-row>
      <i-col>
        <NavBar :activeName="'education'"></NavBar>
      </i-col>
    </i-row>
    <i-row>
      <i-col class="w1200">
                  ...
                  <i-row>
                    <i-col span="12">
                      <div class="animate-box">
                        <div class="animate-title">DNA螺旋展示区</div>
                        <div class="wave">
                          <div class="dot"></div>
                          <div class="dot"></div>
                          <div class="dot"></div>
                      ...
                      <div class="animate-box">
                        ...
                        <div class="campfire">
                          ...
                          <div class="fire">
                            ...
                            <div class="fire-yellow">
                              <div class="flame"></div>
                              <div class="flame"></div>
                              <div class="flame"></div>
                            </div>
                            <div class="fire-white">
                              <div class="flame"></div>
                              <div class="flame"></div>
                              <div class="flame"></div>
                              <div class="flame"></div>
                    ...
                    <i-col span="12">
                      <div class="animate-box">
                        <div class="animate-title">茶杯展示区</div>
                      </div>
                    </i-col>
                    <i-col span="12">
                      <div class="animate-box">
  ...
  .content-center {
    ...
    .animate-box {
      ...
      .wave {
        ...
        perspective: 1000px;
        animation: Spin 20s cubic-bezier(0.42, 0, 0.58, 1) infinite;
        .dot {
          width: 20px;
          height: 1px;
        ...
        .dot:nth-child(1):before {
          animation: Before 3s cubic-bezier(0.42, 0, 0.58, 1) infinite;
        ...
        .dot:nth-child(1):after {
          animation: After 3s cubic-bezier(0.42, 0, 0.58, 1) infinite;
          animation-fill-mode: forwards;
          animation-delay: -0.375s;
      ...
      .campfire {
        ...
        .logs {
          ...
          .log:before {
            ...
            height: 3px;
            border-radius: 50%;
            box-shadow: 0 0 0 1.5px #781e20, 0 0 0 4.5px #b35050, 0 0 0 6px #781e20, 0 0 0 8.5px #b35050, 0 0 0 10px #781e20, 0 0 0 12px #b35050;
          }
          .log:nth-child(1) {
            top: 150px;
            left: 48%;
