...
export default {
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      name: "webgl",
                      children: [{ name: "three.js", value: 100 }]
                    },
                    {
                      name: "本地存储",
                      children: [
                ...
                { name: "ES6", value: 100 },
                {
                  ...
                  children: [
                    ...
                    {
                      name: "webgl(3d动画)",
                      children: [{ name: "tree.js", value: 100 }]
                    },
                    {
                      name: "M*M",
                      children: [
  ...
  methods: {
    ...
    drawChart() {
      ...
      self.interestChart = self.$echarts.init(
        document.getElementById("interestChart")
      );
      self.abilityChart = self.$echarts.init(
        document.getElementById("abilityChart")
      );
      self.skillsChart = self.$echarts.init(
        ...
        series: [
          {
            ...
            data: [{ value: 100 - self.data.html }, { value: self.data.html }]
          }
        ]
      };
      // css能力
        ...
        series: [
          {
            ...
            data: [{ value: 100 - self.data.css }, { value: self.data.css }]
          }
        ]
      };
      // js能力
        ...
        series: [
          {
            ...
            data: [{ value: 100 - self.data.js }, { value: self.data.js }]
          }
        ]
      };
      // ajax能力
        ...
        series: [
          {
            ...
            data: [{ value: 100 - self.data.ajax }, { value: self.data.ajax }]
          }
        ]
      };
      // 兴趣能力
