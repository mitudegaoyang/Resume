const BASECONFIG = [
  {
    ...
    time: '2023/7 至 2023/9',
    img: 'https://z1.ax1x.com/2023/09/26/pP7xSPJ.png',
    content: `<p>医院预算管理是医疗机构管理中至关重要的一部分，它有助于确保医院能够有效地运营并提供高质量的医疗服务。</p>
      <p>预算制定，医院预算管理从制定预算开始。在这个过程中，医院管理团队会考虑医疗服务的范围、设备和设施的需求、人员成本、药品和耗材成本以及其他运营成本。预算应该是基于医院的目标和战略制定的，以确保资源的合理分配。</p>
      <p>成本控制，医院必须密切监控和控制各种成本，包括人员成本、采购成本、运营成本等。成本控制可以通过采取节约措施、提高效率和优化资源使用来实现。</p>
      <p>收入预测，医院预算管理还涉及对收入的预测。这包括来自医保、自费患者和其他来源的收入预测。准确的收入预测可以帮助医院规划资源分配和制定可持续的财务计划。</p>
      <p>绩效评估，医院预算管理还需要对医院的绩效进行定期评估。这包括与实际预算和绩效指标的比较，以便及时纠正任何偏差并采取必要的措施。</p>
      <p>资本支出计划，医院预算管理还需要考虑资本支出，包括新设备、建筑扩展和技术升级等。资本支出计划应与医院的长期战略一致，并确保这些投资能够产生长期价值。</p>
      <p>现金流管理，保持良好的现金流对医院的稳健运营至关重要。医院管理团队需要确保医院有足够的现金来支付日常开支，包括员工工资、供应商付款和设备维护。</p>
      <p>风险管理，医院必须考虑潜在的风险和不确定性，如法律诉讼、医疗责任险和自然灾害等。预算管理应该包括风险管理策略，以应对不可预测的事件。</p>
      <p>秉承着“以需定产，以产定投”的核心宗旨，确保医院能够提供高质量的医疗服务，同时保持财务稳健。</p>
      <ul>
        <li>基于 Ant Design Pro 组件，实现各页面布局及特效；</li>
        <li>使用 single-spa 实现微服务项目架构；</li>
        <li>使用 emotion 实现 JS 编写 css 样式；</li>
      </ul>`,
    link: {
      title: '',
      src: ''
      // title: '内网地址（需使用 PC 访问）',
      // src: 'http://192.168.5.184:8080/console'
    }
  },
  {
    title: '日常质量管理',
    ...
    time: '2023/4 至 2023/7',
    img: 'https://z1.ax1x.com/2023/09/26/pP7vvaF.png',
    content: `<p>日常质量管理系统，是一种用于医院在日常运营中采取的一系列管理活动和措施，旨在确保患者安全、提高医疗服务质量、降低医疗错误、提高患者满意度，并遵守法规和行业标准。</p>
      <p>系统依托于全面质量管理系统，将其中的标准功能浓缩提炼，并结合医院在日常运营中的场景，进行整合重组，以满足不同医院的业务需求。</p>
      <p>日常质量管理系统，可以帮助医疗机构制定和实施质量管理计划，并持续评估和改进其质量管理体系，以适应不断变化的医疗环境和最佳实践。</p>
      <ul>
        <li>基于 Ant Design Pro 组件，实现各页面布局及特效；</li>
        <li>使用 single-spa 实现微服务项目架构；</li>
        <li>使用 cloud-charts 实现图表的展示；</li>
        <li>使用 classnames 在 React 组件中方便地处理 className 字符串</li>
        <li>使用 eventemitter2 在组件间进行事件传递</li>
      </ul>`,
    link: {
      title: '',
      src: ''
      // title: '内网地址（需使用 PC 访问）',
      // src: 'http://192.168.5.172:9091'
    }
  },
  {
    title: '高质量发展建设管理',
    ...
    tags: [
      ...
      {
        name: 'tgg-large-screen',
        value: 'tgg-large-screen'
      }
    ],
    time: '2022/10 至 2022/12',
    img: 'https://z1.ax1x.com/2023/09/26/pP7vx54.png',
    content: `<p>医疗高质量发展建设管理系统是一种针对医疗机构和卫生管理部门设计的综合性软件产品，旨在提高医疗服务的质量、效率和管理水平。该系统包含多个模块和功能，以满足不同医疗机构的需求，并有助于实现医疗行业的可持续发展和改进。</p>
      <p>模块包括管理主页、运营指标驾驶舱、领导组织体系、高质量发展框架、建设进度管理、项目建设管理、发展指标管理、项目预算管理、区域医疗中心监管等模块。</p>
      <p>医疗高质量发展建设管理系统是一个全面的解决方案，可以帮助医疗机构提高高质量发展建设、优化资源利用、提高医疗质量，并确保医院合规运营。这有助于实现医疗高质量发展的目标，提供更好的医疗服务，保障患者的健康和安全。</p>
      <ul>
        <li>基于 Ant Design Pro 组件，实现各页面布局及特效；</li>
        <li>使用 single-spa 实现微服务项目架构；</li>
        <li>使用 cloud-charts 实现图表的展示；</li>
        <li>使用 classnames 在 React 组件中方便地处理 className 字符串</li>
        <li>使用 tgg-large-screen 解决大屏满屏等比无压缩自适应需求</li>
      </ul>`,
    link: {
      title: '',
      src: ''
      // title: '内网地址（需使用 PC 访问）',
      // src: 'http://192.168.5.172:8101'
    }
  },
  {
    title: '全面质量管理',
    ...
    time: '2022/6 至 2023/6',
    img: 'https://z1.ax1x.com/2023/09/26/pP7vjVU.png',
    content: `<p>全面质量管理系统，是一种用于提高医院医疗质量和安全性的软件系统，它能够帮助医疗机构管理和监督医疗过程、患者安全、医疗设备和医疗人员的表现。</p>
      <p>包括九宫格、数据大屏、评审管理、国考管理、委员会管理、医务管理(职能科室管理)、人事管理、临床科室管理、医技科室管理、科室质控小组管理、质控检查、持续改进管理、个人技术档案、不良事件上报、指标管理、系统管理等模块。</p>
      <p>系统从如下几个方面，提高医院能力。患者安全管理可以帮助医院识别和减少患者风险，提高医疗安全。</p>
      <p>医疗过程监督有助于降低医疗失误和提高治疗质量。</p>
      <p>数据收集和分析有助于帮助医院管理层做出更明智的决策，改进医疗流程。</p>
      <p>质控报告和指标，系统可以生成各种质控报告和指标，用于评估医院的绩效。指标可以包括患者满意度、医疗错误率、手术成功率等。</p>
      <p>医疗设备管理有助于帮助医院管理医疗设备的维护和保养，确保设备的正常运行，以减少医疗事故的风险。</p>
      <p>医疗人员培训和认证有助于跟踪医疗人员的培训和认证情况，确保他们具备必要的技能和知识来提供高质量的医疗服务。</p>
      <ul>
        <li>基于 Ant Design Pro 组件，实现各页面布局及特效；</li>
        <li>使用 single-spa 实现微服务项目架构；</li>
        <li>使用 cloud-charts 实现图表的展示；</li>
        <li>使用 formilyjs 实现表单的快速搭建；</li>
        <li>使用 classnames 在 React 组件中方便地处理 className 字符串</li>
        <li>使用 eventemitter2 在组件间进行事件传递</li>
      </ul>`,
    link: {
  ...
  },
  {
    ...
    time: '2021/4 至 2022/6',
    img: 'https://s1.ax1x.com/2022/05/28/XKAcVg.png',
    content: `<p><a href="https://data.iyiou.com/share/briefing/sTwN2aP01X" target="_blank" title="亿欧数据帮助中心">亿欧数据</a>
      的产品定位是为能引领科技与产业发展的组织，提供好用的行业洞察工具，有效的商业决策工具。</p>
      <p>包括首页、情报监测、行业分析、企业分析、数据分析、工作台等模块。</p>
      <p>本产品帮助亿欧公司进行能力升级，把日常业务开展的过程中形成的标准化流程、结构化数据和高质量方法论。</p>
      <p>通过大数据仓库，将这些数据有效的存储和管理起来，以这些数据为支撑，建立数据产品化，推动公司数字化浪潮。</p>
      <p>产品从用户使用场景出发，共分为写市场简报、扫描企业信息、查看领域信息、领域指标分析、高效在线作图五大场景。</p>
      <ul>
        <li>基于 Ant Design of Vue 组件，实现各页面布局及特效；</li>
        <li>使用 wangeditor 实现富文本编辑器；</li>
        <li>使用 Echarts 实现图表的展示；</li>
        <li>编写高级筛选等公共组件，对系统进行模块化组件化开发；</li>
        <li>使用 SSR 技术，提高产品的首屏加载速度，优化 SEO，增加产品的曝光率和流量；</li>
      </ul>`,
    link: {
